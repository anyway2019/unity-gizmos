...
public class Davinci : MonoBehaviour
{
    ...
    public void start()
    {
        ...
        if (underProcessDavincies.TryGetValue(uniqueHash, out var davincy))
        {
            davincy.onDownloadedAction += () =>
            {
    ...
    private void SetLoadingImage()
    {
        switch (rendererType)
        {
            ...
            case RendererType.uiImage:
                ...
                var sprite = Sprite.Create(loadingPlaceholder,
            ...
            case RendererType.sprite:
                ...
                var spriteImage = Sprite.Create(loadingPlaceholder,
                    new Rect(0, 0, loadingPlaceholder.width, loadingPlaceholder.height),
                    new Vector2(0.5f, 0.5f));
